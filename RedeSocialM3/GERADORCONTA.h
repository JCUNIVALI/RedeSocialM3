...
void GERADOR_DE_CONTA(T *lista) {
	...
	lista->InserirPost(new ElementoListaPost(new Post("Dona @Dilma_Rousseff so nao vou te estupra por que voce nao merece..", "@Bolsonaro2018")));
	lista->InserirPost(new ElementoListaPost(new Post("@Dilma_Rousseff e lugar de bandido, senhora presidente? Onde e? Livre, nas ruas para barbarizar o cidadao de bem impunemente?", "@Rachel_Sheherazade")));
	lista->InserirPost(new ElementoListaPost(new Post("Lugar de bandido @Rachel_Sheherazade e saudando a mandioca, o que me lembra que por traz de uma crianca sempre tem um cachorro.", "@Dilma_Rousseff")));
	lista->InserirPost(new ElementoListaPost(new Post("Sentiu esse cheiro? Foi mal ja cheirei", "@Aecio_Neves")));
