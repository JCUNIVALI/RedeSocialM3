...
void GERADOR_DE_CONTA(T *lista) {
	...
	lista->InserirPost(new ElementoListaPost(new Post("E lugar de bandido, senhora presidente? Onde e? Livre, nas ruas para barbarizar o cidadão de bem impunemente?", "@Rachel_Sheherazade")));
